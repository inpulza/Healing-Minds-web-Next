...
const WhatsAppFloatingButton = () => {
  ...
  const whatsappNumber = '12399201019';
  const messageEn = encodeURIComponent('Hello! I would like to schedule an appointment with Dr. Melva Reve.');
  const messageEs = encodeURIComponent('¡Hola! Me gustaría agendar una cita con la Dra. Melva Reve.');
