          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <Link href="/contact">
                  <Button
                    className={`group inline-flex items-center justify-center gap-2 sm:gap-3 rounded-full text-sm sm:text-base font-semibold transition-all duration-300 px-5 sm:px-7 py-5 sm:py-6 ${
                      service.featured
