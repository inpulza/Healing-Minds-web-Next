        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 xl:p-16 shadow-lg border border-green-100">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="text-green-800 order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-display font-bold mb-4 sm:mb-6" data-testid="doctor-section-title">
                {language === 'en' 
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 font-body leading-relaxed" data-testid="doctor-section-description">
                {language === 'en'
