  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Healing Minds Psychiatry is a telepsychiatry practice led by Dr. Melva Reve, a licensed psychiatrist. Telehealth means that your psychiatric evaluation and follow-up appointments are conducted remotely through a secure, real-time video connection rather than a traditional in-person office visit. This allows you to receive care from a private location of your choosing.',
        ],
      },
      {
        key: 'legal-basis',
      ...
      },
      {
        ...
        bullets: [
          '**Access:** Reach a licensed psychiatrist without the need to travel to an office.',
  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          '**Acceso:** Comuníquese con una psiquiatra con licencia sin necesidad de trasladarse a una oficina.',
