...
export const hipaaNoticeContent: BilingualPageContent = {
  en: {
    ...
    sections: [
      ...
      {
        key: 'effective-date',
        paragraphs: [`Effective Date: [TO BE PROVIDED]`],
      },
      {
        key: 'intro',
        paragraphs: [
      ...
      },
      {
        key: 'your-rights',
        heading: `YOUR RIGHTS`,
        paragraphs: [`The following is a statement of your rights with respect to your protected health information.`],
      },
      {
        key: 'right-inspect',
        heading: `Right to Inspect and Copy`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'right-accounting',
        heading: `Right to Accounting of Disclosures`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'right-amendment',
        heading: `Right to Request Amendment`,
        level: 3,
        paragraphs: [
      ...
      },
      {
        ...
        level: 3,
        paragraphs: [`[This section would be completed during patient intake at the practice]`],
      },
    ],
  },
  es: {
    ...
    sections: [
      ...
      {
        key: 'effective-date',
        paragraphs: [`Fecha de Vigencia: [A SER PROPORCIONADA]`],
      },
      {
        key: 'intro',
        paragraphs: [
      ...
      {
        key: 'healthcare-operations',
        heading: `OPERACIONES DE ATENCIÓN MÉDICA:`,
        level: 3,
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [`Lo siguiente es una declaración de sus derechos con respecto a su información de salud protegida.`],
      },
      {
        key: 'right-inspect',
      ...
      {
        key: 'right-confidential',
        heading: `Derecho a Comunicaciones Confidenciales`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'right-accounting',
        heading: `Derecho a Contabilidad de Divulgaciones`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'right-amendment',
        heading: `Derecho a Solicitar Enmienda`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'right-paper',
        heading: `Derecho a una Copia Impresa`,
        level: 3,
        paragraphs: [
      ...
      {
        key: 'patient-signature',
        heading: `FIRMA DEL PACIENTE`,
        level: 3,
        paragraphs: [`[Esta sección se completaría durante la admisión del paciente en la práctica]`],
      },
    ],
  },
};
