// Shared UI translations for English and Spanish.
// Pure data module: imported by the React LanguageContext AND by the
// server-side bot-body generator (server/utils/html-injection.ts), so it must
// stay free of JSX, React imports and asset imports.
