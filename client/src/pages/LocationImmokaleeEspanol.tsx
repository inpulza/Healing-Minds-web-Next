...
const LocationImmokaleeEspanol = () => {
  ...
  useEffect(() => {
    ...
    const seoData = {
      title: 'Psiquiatra Immokalee FL - Dra. Melva Reve | Healing Minds',
      description: 'La Dra. Melva Reve atiende Immokalee, FL. Atención psiquiátrica experta para ansiedad, depresión, TDAH, TEPT. Llame (239) 423-0272 para programar.',
      keywords: 'psiquiatra Immokalee FL, salud mental Immokalee, Dra Melva Reve Immokalee, atención psiquiátrica Immokalee FL',
      lang: 'es',
      canonical: '/es/ubicaciones/psiquiatra-immokalee'
    };
    updateSEO(seoData);
    ...
    addLocationServiceSchema({
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.healingmindsp.com/es/ubicaciones/psiquiatra-immokalee",
  ...
  const contentData = {
    en: {
      title: "Expert Psychiatric Care in Immokalee",
      subtitle: "Compassionate mental health services for the Immokalee community",
      addressTitle: "Our Naples Office",
      contactTitle: "Contact Information", 
      hoursTitle: "Office Hours",
      servicesTitle: "Mental Health Services",
      insuranceTitle: "Accepted Insurance Plans",
      areaTitle: "Serving Immokalee & Surrounding Areas",
      mapTitle: "Find Us on the Map",
      bookNow: "Book Appointment",
      getDirections: "Get Directions",
      callNow: "Call Now",
      appointmentSubtitle: "Schedule your consultation today",
      communityTitle: "Immokalee Community Focus",
      communityDescription: "We understand the unique needs of Immokalee residents and provide culturally sensitive care.",
      features: [
        {
        ...
        },
        {
          ...
          description: "Easy drive from Immokalee to our Naples office location"
        }
      ],
      services: [
    ...
    es: {
      title: "Atención Psiquiátrica Experta en Immokalee",
      subtitle: "Servicios compasivos de salud mental para la comunidad de Immokalee",
      ...
      areaTitle: "Sirviendo Immokalee y Áreas Circundantes",
      mapTitle: "Encuéntrenos en el Mapa",
      bookNow: "Reservar Cita",
      getDirections: "Obtener Direcciones",
      callNow: "Llamar Ahora",
      appointmentSubtitle: "Programe su consulta hoy",
      communityTitle: "Enfoque en la Comunidad de Immokalee",
      communityDescription: "Entendemos las necesidades únicas de los residentes de Immokalee y proporcionamos atención culturalmente sensible.",
      features: [
        {
        ...
        },
        {
          ...
          description: "Fácil manejo desde Immokalee a nuestra ubicación de oficina en Naples"
        }
      ],
      services: [
      ...
      <main>
              ...
              <div className="relative">
                <div className="relative z-10">
                  <OptimizedImage
                    ...
                    alt="Dr. Melva Reve Office serving Immokalee"
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Comprehensive mental health services for Immokalee residents
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                Preguntas Frecuentes - Immokalee
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Respuestas a preguntas comunes de residentes de Immokalee
              </p>
            </div>
            
            <LocationFAQ 
              locationFAQs={locationFAQs.immokalee} 
            />
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
              Como residente de Immokalee, tiene acceso a atención psiquiátrica experta. Contáctenos para programar su consulta.
            </p>
...
export default LocationImmokaleeEspanol;