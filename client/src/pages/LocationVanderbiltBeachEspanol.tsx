...
const LocationVanderbiltBeachEspanol = () => {
  ...
  useEffect(() => {
    ...
    const seoData = {
      title: 'Psiquiatra Vanderbilt Beach FL - Dra. Melva Reve | Healing Minds',
      description: 'La Dra. Melva Reve atiende Vanderbilt Beach, FL. Atención psiquiátrica experta para ansiedad, depresión, TDAH, TEPT. Llame (239) 423-0272 para programar.',
      keywords: 'psiquiatra Vanderbilt Beach FL, salud mental Vanderbilt Beach, Dra Melva Reve Vanderbilt Beach, atención psiquiátrica Vanderbilt Beach FL',
      lang: 'es',
      canonical: '/es/ubicaciones/psiquiatra-vanderbilt-beach'
    };
    updateSEO(seoData);

    // This schema points to the main MedicalClinic as provider, avoiding conflicts
    const serviceDescription = 'Atención psiquiátrica experta para residentes de Vanderbilt Beach. La Dra. Melva Reve proporciona servicios integrales de salud mental incluyendo tratamiento de ansiedad, terapia de depresión, evaluación de TDAH, tratamiento de TEPT, manejo de trastorno bipolar, y manejo de medicamentos psiquiátricos para la comunidad de Vanderbilt Beach.';
    
    addLocationServiceSchema({
      "@type": "Service",
      "name": "Atención Psiquiátrica en Vanderbilt Beach, FL",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.healingmindsp.com/es/ubicaciones/psiquiatra-vanderbilt-beach",
  ...
  const contentData = {
    en: {
      title: "Expert Psychiatric Care in Vanderbilt Beach",
      subtitle: "Compassionate mental health services for the Vanderbilt Beach community",
      addressTitle: "Our Naples Office",
      contactTitle: "Contact Information", 
      hoursTitle: "Office Hours",
      servicesTitle: "Mental Health Services",
      insuranceTitle: "Accepted Insurance Plans",
      areaTitle: "Serving Vanderbilt Beach & Surrounding Areas",
      mapTitle: "Find Us on the Map",
      bookNow: "Book Appointment",
      getDirections: "Get Directions",
      callNow: "Call Now",
      appointmentSubtitle: "Schedule your consultation today",
      communityTitle: "Vanderbilt Beach Community Focus",
      communityDescription: "We understand the unique needs of Vanderbilt Beach residents and provide culturally sensitive care.",
      features: [
        {
        ...
        },
        {
          ...
          description: "Easy drive from Vanderbilt Beach to our Naples office location"
        }
      ],
      services: [
    ...
    es: {
      title: "Atención Psiquiátrica Experta en Vanderbilt Beach",
      subtitle: "Servicios compasivos de salud mental para la comunidad de Vanderbilt Beach",
      ...
      areaTitle: "Sirviendo Vanderbilt Beach y Áreas Circundantes",
      mapTitle: "Encuéntrenos en el Mapa",
      bookNow: "Reservar Cita",
      getDirections: "Obtener Direcciones",
      callNow: "Llamar Ahora",
      appointmentSubtitle: "Programe su consulta hoy",
      communityTitle: "Enfoque en la Comunidad de Vanderbilt Beach",
      communityDescription: "Entendemos las necesidades únicas de los residentes de Vanderbilt Beach y proporcionamos atención culturalmente sensible.",
      features: [
        {
        ...
        },
        {
          ...
          description: "Fácil manejo desde Vanderbilt Beach a nuestra ubicación de oficina en Naples"
        }
      ],
      services: [
      ...
      <main>
              ...
              <div className="relative">
                <div className="relative z-10">
                  <OptimizedImage
                    ...
                    alt="Dr. Melva Reve Office serving Vanderbilt Beach"
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Comprehensive mental health services for Vanderbilt Beach residents
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                Preguntas Frecuentes - Vanderbilt Beach
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Respuestas a preguntas comunes de residentes de Vanderbilt Beach
              </p>
            </div>
            
            <LocationFAQ 
              locationFAQs={locationFAQs.vanderbiltBeach} 
            />
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
              Como residente de Vanderbilt Beach, tiene acceso a atención psiquiátrica experta. Contáctenos para programar su consulta.
            </p>
...
export default LocationVanderbiltBeachEspanol;