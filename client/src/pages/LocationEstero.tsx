          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="md:hidden">
              <div className="relative aspect-[4/5] mb-4 rounded-2xl overflow-hidden">
                <OptimizedImage src={heroLocationImage} alt="Dr. Melva Reve serving Estero" className="w-full h-full object-cover" style={{ objectPosition: '95% top' }} width={800} height={1000} priority={true} sizes="100vw" />
