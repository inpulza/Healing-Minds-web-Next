...
const ServicesPage = () => {
  ...
  useEffect(() => {
    const seoData = {
      title: language === 'en'
        ? 'Psychiatric Services Naples FL - Anxiety, Depression, ADHD Treatment | Healing Minds'
        : 'Servicios Psiquiátricos Naples FL - Tratamiento Ansiedad, Depresión, TDAH | Healing Minds',
      description: language === 'en'
        ? 'Comprehensive psychiatric services in Naples, FL by Dr. Melva Reve. Evidence-based treatment for anxiety, depression, ADHD, PTSD, and bipolar disorder. Bilingual care, in-person and telehealth. Call (239) 423-0272.'
        : 'Servicios psiquiátricos integrales en Naples, FL por la Dra. Melva Reve. Tratamiento basado en evidencia para ansiedad, depresión, TDAH, TEPT y trastorno bipolar. Atención bilingüe, presencial y telehealth. Llame (239) 423-0272.',
      keywords: language === 'en'
        ? 'psychiatric services Naples FL, anxiety treatment Naples, depression treatment Naples, ADHD treatment Naples, PTSD treatment Naples, bipolar treatment Naples, medication management Naples, bilingual psychiatrist Naples'
        : 'servicios psiquiátricos Naples FL, tratamiento ansiedad Naples, tratamiento depresión Naples, tratamiento TDAH Naples, tratamiento TEPT Naples, tratamiento bipolar Naples, manejo medicamentos Naples, psiquiatra bilingüe Naples',
      lang: language,
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-16">
        ...
        {/* Page Hero — unique H1 for this route */}
