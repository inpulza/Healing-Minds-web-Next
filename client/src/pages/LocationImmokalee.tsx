            ...
            <div className="md:hidden">
              ...
              <div className="relative h-[400px] sm:h-[450px] mb-4 rounded-2xl overflow-hidden">
                <OptimizedImage
                  ...
                  alt="Dr. Melva Reve serving Immokalee"
                  ...
                  <div className="max-w-2xl text-left">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-sm hover:shadow-md transition-shadow duration-200 border border-green-100">
                        ...
                        <span className="text-gray-700 font-body font-medium text-xs sm:text-sm">
                          {language === 'en' ? 'Serving Immokalee' : 'Sirviendo Immokalee'}
                        </span>
                      </div>
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-6 mt-8">
              <div className="text-center">
                ...
                <Link href={language === 'en' ? '/contact' : '/es/contacto'} data-testid="button-contact-immokalee">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                <Button 
                  ...
                  onClick={() => {
                    trackLeadConversion('phone_call', { click_location: 'immokalee_final_cta' });
