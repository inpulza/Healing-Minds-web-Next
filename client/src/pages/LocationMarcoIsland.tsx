          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed max-w-4xl mx-auto font-body">
                {language === 'en' 
                  ? 'Expert mental health and telepsychiatry services for the Marco Island community. Whether you need a psychiatrist in Marco Island for an ADHD evaluation or are seeking compassionate depression treatment Marco Island FL, our clinic is just across the bridge. We offer bilingual care specializing in anxiety treatment in Naples FL, depression, PTSD, and psychiatric medication management for island residents.'
                  : 'Servicios expertos de salud mental y telepsiquiatría para la comunidad de Marco Island. Ya sea que necesite un psiquiatra en Marco Island para una evaluación de TDAH o esté buscando tratamiento de depresión compasivo, nuestra clínica está justo al otro lado del puente. Ofrecemos atención bilingüe especializada en ansiedad, depresión, TEPT y manejo de medicamentos psiquiátricos para residentes de la isla.'}
              </p>
