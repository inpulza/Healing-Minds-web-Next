...
**Evidencia:** TypeScript PASS, suite 100/100 PASS, build Next 89/89 PASS, guards de pageview PASS, pruebas browser 4/4 PASS, contrato focalizado del auditor 6/6 PASS y E2E local ampliado 14/14 PASS en escritorio y móvil. La matriz cubre consentimiento mixto A1/M0, persistencia en back/forward, borradores descartados y localización completa de Cancelar; el caso español también reabre el modal directamente desde el footer.
