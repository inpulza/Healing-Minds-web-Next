# Spec retrospectivo: Servicios de telehealth
...
- Selector original registrado: `main > div:nth-child(3)`.
- Rol: servicios de telehealth.
- Modo: `clon`.
- Código mapeado: `client/src/components/TelehealthSection.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1489 px**.
