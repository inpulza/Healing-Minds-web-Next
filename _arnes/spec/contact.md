# Spec retrospectivo: Contacto y mapa
...
- id: `contact`.
- Selector original registrado: `main > div:nth-child(12)`.
- Rol: contacto y mapa.
- Modo: `clon`.
- Código mapeado: `client/src/components/Contact.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **2034 px**.
