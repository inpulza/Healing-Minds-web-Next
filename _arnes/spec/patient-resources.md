# Spec retrospectivo: Información para pacientes
...
- Selector original registrado: `main > div:nth-child(10)`.
- Rol: información para pacientes.
- Modo: `clon`.
- Código mapeado: `client/src/components/ForPatients.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1228 px**.
