# Spec retrospectivo: Reseñas de pacientes
...
- id: `patient-reviews`.
- Selector original registrado: `main > div:nth-child(9)`.
- Rol: reseñas de pacientes.
- Modo: `clon`.
- Código mapeado: `client/src/components/Reviews.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1011 px**.
