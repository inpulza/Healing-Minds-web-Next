# Spec retrospectivo: Presentación profesional
...
- id: `doctor-profile`.
- Selector original registrado: `main > div:nth-child(4)`.
- Rol: presentación profesional.
- Modo: `clon`.
- Código mapeado: `client/src/components/DoctorSection.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **809 px**.
