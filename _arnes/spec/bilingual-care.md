# Spec retrospectivo: Cuidado bilingüe
...
- id: `bilingual-care`.
- Selector original registrado: `main > div:nth-child(6)`.
- Rol: cuidado bilingüe.
- Modo: `clon`.
- Código mapeado: `client/src/components/BilingualCare.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **999 px**.
