# Spec retrospectivo: Áreas de servicio
...
- id: `service-areas`.
- Selector original registrado: `main > div:nth-child(7)`.
- Rol: áreas de servicio.
- Modo: `clon`.
- Código mapeado: `client/src/components/ServiceAreas.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1211 px**.
