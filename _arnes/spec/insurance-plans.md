# Spec retrospectivo: Planes de seguro
...
- id: `insurance-plans`.
- Selector original registrado: `main > section:nth-child(2)`.
- Rol: planes de seguro.
- Modo: `clon`.
- Código mapeado: `client/src/components/InsuranceLogos.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1108 px**.
