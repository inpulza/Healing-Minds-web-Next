# Spec retrospectivo: Servicios de salud mental
...
- Selector original registrado: `main > div:nth-child(5)`.
- Rol: servicios de salud mental.
- Modo: `clon`.
- Código mapeado: `client/src/components/Services.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **1132 px**.
