# Spec retrospectivo: CTA principal
...
- id: `primary-cta`.
- Selector original registrado: `main > div:nth-child(8)`.
- Rol: cta principal.
- Modo: `clon`.
- Código mapeado: `client/src/components/CTASection.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **491 px**.
