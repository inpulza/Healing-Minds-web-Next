# Spec retrospectivo: Hero principal
...
- id: `hero`.
- Selector original registrado: `main > section:nth-child(1)`.
- Rol: hero principal.
- Modo: `clon`.
- Código mapeado: `client/src/components/Hero.tsx` mediante `client/src/pages/Home.tsx`.

## Geometría

- Altura fuente registrada a 1440 px: **704 px**.
