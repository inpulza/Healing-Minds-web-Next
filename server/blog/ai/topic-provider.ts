...
export async function generateTopicCandidateBatch(input: {
  ...
  const call = () => createStructuredResponse({
    ...
    system: [
      ...
      "Do not use the words patient or paciente in topic, targetKeyword, or expertiseAngle; those administrative AI fields are fail-closed and must use neutral public-topic language.",
